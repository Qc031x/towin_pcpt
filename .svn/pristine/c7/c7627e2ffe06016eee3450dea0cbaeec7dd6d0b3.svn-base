...
public interface IServiceRequest {
    ...
    public String sendHttpsWapPost(String wapApiUrl,Object xmlObj)throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException ;
