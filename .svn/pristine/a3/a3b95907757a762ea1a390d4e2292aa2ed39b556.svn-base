...
//		result = sendTextSms("15951977097", "您的验证码为：3123，请勿向任何人提供短信验证码");
	...
	public static  Map<String, String> getMobileMsgMap(String[] context,String mobile,String mobileTemp){
		  ...
		  if(mobileTemp.equals("JSM40990-0010")){		 
			  ...
			  map.put("content", "@account@="+context[0]+",@oid@="+context[1]);
		  }else if(mobileTemp.equals("JSM40990-0011")){
			  map.put("content","@account@="+context[0]+",@securityCode@="+context[1]);
		  }else if(mobileTemp.equals("JSM40990-0021")){
			  map.put("content","@account@="+context[0]+",@password@="+context[1]);
		  }else if(mobileTemp.equals("JSM40990-0015")){
			  map.put("content","@card@="+context[0]+",@password@="+context[1]+",@passDate@="+context[2]);
		  }else if(mobileTemp.equals("JSM40990-0003")){
			  map.put("content","@coin@="+context[0]+",@card@="+context[1]+",@password@="+context[2]+",@passDate@="+context[3]);
		  }
		  return map;
	}
