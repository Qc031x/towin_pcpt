...
<div class="main">
    <div class="header">
        ...
        <div class="header_info">套餐详情</div>
    ...
    <div class="ornament">
        ...
        <div class="info">
            ...
            <p style="line-height: 2;"><b>${map['baseInfoMap']['SHOP_PRICE']}</b><s>￥${map['baseInfoMap']['MARKET_PRICE']}</s><span>已售${map['baseInfoMap']['COUNT']}</span></p>
         <c:choose>
         	...
         	<c:otherwise>
         		<c:choose>
         			<c:when test="${map['baseInfoMap']['coupon'] eq 1}">
         				<p style="margin: 0;color: #999999;font-size: 10px;padding: 0;line-height: 1.9;">
		         		<span style="float: left;width: 50px;height: 18px;background: #f36060;border-radius: 3px 0 0 3px;text-align: center;line-height: 18px;color: #fff;display: inline-block;">在线支付</span>
		         		<em style="width: 50px;text-align: center;float: left;display: inline-block;height: 18px;color: #716f6f;background-color: #e3e3e3;border-radius: 0 3px 3px 0;line-height: 18px;">立减<i style="color: #f36060;">${map['baseInfoMap']['PRICE']}</i>元</em>
		         		</p>
         			</c:when>
         			<c:otherwise>
         				<p style="margin: 0;color: #999999;font-size: 10px;padding: 0;line-height: 1.9;">
...
<%--     <c:forEach items="${map['promotions']}" var="promotion" varStatus="status">
	<div class="onsale">
        <a href="/core/product.toPromotionsDetail.do?pid=${map['baseInfoMap']['PID']}">${promotion['PROMOTION_TITLE']}</a>
    </div>
	</c:forEach> --%>
    ...
    <!--切换-->
    <ul class="prostore">
        <li class="active"><a href="javascript:;">项目详情</a></li>
        <li class=""><a href="javascript:;">适用机构</a></li>
    </ul>
    ...
    <div class="tablebox">
        <!--项目详情-->
        <div class="proinfo" style="display: block;">
        ...
        <!--门店信息-->
        <div class="appmech">
            <%@include file="/WEB-INF/content/public/shopCity.jsp" %>
...
$(".cardtype em").click(function(){
    ...
    /*切换悬浮*/
    var gps = $("#gps").offset().top;
    $(window).scroll(function () {
        if ($(window).scrollTop() >= gps) {
            $(".prostore").css({
                top: "2.5rem",
                position: "fixed",
                "z-index": "100"
